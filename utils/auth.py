...
class Auth:
    ...
    def get_users(self):
        try:
            ...
            raise RuntimeError(f"Kamu belum registrasi, ketik `/login` untuk register!") 
    ...
    def get_entitlements_token(self):
        ...
        try:
            ...
            raise RuntimeError(f'Sesi anda habis, tolong /login lagi!')  #{r.json()["message"]}
    ...
    def get_userinfo(self):
        ...
        try:
            ...
            raise RuntimeError(f'Ada terjadi error, tolong /login lagi')
    ...
    def temp_auth(self):
        ...
        if r.json()['type'] == 'response':
            ...
            raise RuntimeError("Jika anda belum register dan tidak ada 2FA, tolong `/login` lagi")
        else:
            raise RuntimeError('Password atau Username anda salah')
